...
<header class="php"></header>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="item active">
                <img src="img_home/deti.jpg" alt="Slide 1">
                <div class="carousel-caption">
                    <h3>Albania</h3>
                    <p>Small country. Big surprises.</p>
                </div>
            </div>

            <div class="item">
                <img src="img_home/mal.jpg" alt="Slide 2">
                <div class="carousel-caption">
                    <h3>Albania</h3>
                    <p>Small country. Big surprises.</p>
                </div>
            ...
            <div class="item">
                <img src="img_home/qyteti.jpg" alt="Slide 3">
                <div class="carousel-caption">
                    <h3>Albania</h3>
                    <p>Small country. Big surprises.</p>
                </div>
    ...
    <section class="quote-section">
        <p>Landscapes that will take your breath away, rich history, and delicious food. Your trip to Albania will be nothing short of unforgettable.</p>
    </section>

    <!-- Discover Albania Section -->
    <section class="discover-albania">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    
                    <!-- SVG map with clickable paths -->
                    <div id="albania-map">
                    <?xml version="1.0"?>
...
<svg baseprofile="tiny" fill="#6f9c76" height="400" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width=".5" version="1.2" viewbox="0 0 1000 1000" width="400" xmlns="http://www.w3.org/2000/svg">
 <g id="features">
    <a href="https://albania.al/destinations/dibra/">
  ...
  <a href="https://albania.al/destinations/kukes/">
  ...
  <a href="https://albania.al/destinations/korca/">
  ...
  <a href="https://albania.al/destinations/elbasan/">
  ...
  <a href="https://albania.al/destinations/gjirokastra/">
  ...
  <a href="https://albania.al/destinations/vlora/">
  ...
  <a href="https://albania.al/destinations/shkodra/">
  ...
  <a href="https://albania.al/destinations/fieri/">
  ...
  <a href="https://albania.al/destinations/tirana/">
  ...
  <a href="https://albania.al/destinations/durres/">
  ...
  <a href="https://albaniavisit.com/destinations/lezhe/">
  ...
  <a href="https://albania.al/destinations/berat/">
...
<div id="tooltip"></div>
                ...
                <div class="col-md-6">
                    <div id="city-carousel" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="item active">
                                <img src="img_home/tirana.jpg" alt="Tirana">
                                <div class="carousel-caption">
                                    <h3>Tirana</h3>
                                    <p>The vibrant capital of Albania, known for its colorful buildings and rich history.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Rich History and Food Section -->
    <section class="info-section">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="info-box">
                        <img src="img_home/Rozafa.jpg" alt="History" class="img-responsive" id="his">
                        <h2 class="rich">RICH HISTORY</h2>
                        <h4>DISCOVER THE ROOTS OF ALBANIA.</h4>
                        <button class="btn btn-primary"><a href="https://history-maps.com/story/History-of-Albania" id="link">CLICK FOR MORE</a></button>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="info-box">
                        <img src="img_home/Byrek.jpg" alt="Food" class="img-responsive" id="food">
                        <h2 class="rich">FOOD</h2>
                        <h4>EXPLORE ALBANIAN CUISINE.</h4>
                        <button class="btn btn-primary"><a href="https://wanderingwheatleys.com/traditional-albanian-foods-to-try-in-albania/" id="link">CLICK FOR MORE</a></button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="stay-with-us">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img src="img_home/email.png" alt="Stay with Us" class="img-responsive email">
                </div>
                <div class="col-md-6">
                    <h2 id="stay">STAY WITH US</h2> 
                    <p>Continue living like an Albanian. <br>
                        Subscribe to not miss events and experiences that showcase the best of Albania.</p><br>
